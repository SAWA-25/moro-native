...
const importers: Partial<Record<AppID, () => Promise<unknown>>> = {
  ...
  [AppID.Presets]: () => import('../../apps/PresetApp'),
  [AppID.Personas]: () => import('../../apps/PersonaHubApp'),
  [AppID.Regex]: () => import('../../apps/RegexApp'),
  [AppID.Novel]: () => import('../../apps/NovelApp'),
  [AppID.Bank]: () => import('../../apps/BankApp'),
  [AppID.CoView]: () => import('../../apps/CoViewApp'),
  [AppID.XhsFreeRoam]: () => import('../../apps/CoViewApp'),
  [AppID.Xunji]: () => import('../../apps/XunjiApp'),
  ...
  [AppID.Shop]: () => import('../../apps/ShopApp'),
  [AppID.Harem]: () => import('../../apps/HaremApp'),
  [AppID.Forum]: () => import('../../apps/ForumApp'),
  [AppID.Twitter]: () => import('../../apps/TwitterApp'),
  [AppID.VideoCall]: () => import('../../apps/VideoCallApp'),
