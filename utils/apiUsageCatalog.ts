...
export const API_USAGE_CATALOG = [
    ...
    feature('chat.offlineMode', AppID.GroupChat, '絮语', '线下模式', '生成线下面对面情景', ['絮语', '聊天工具', '线下模式'], 'aux', false),
    feature('chat.groupOfflineMode', AppID.GroupChat, '絮语', '群聊线下模式', '生成群体见面情景', ['絮语', '群聊', '线下模式'], 'aux', false),
